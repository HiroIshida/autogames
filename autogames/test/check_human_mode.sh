...
#########################################################################################
# This script cannot locate in .travis.yml because travis system does not have keyboard #
#########################################################################################
...
SCRIPTS=("autogames_server --game tictactoe_game --port 65432 &" # server
         ...
         "python autogames/client/python/client.py --port 65432 --agent-file example_agent_tictactoe --timeout 30 &" # client2 with Python
        )
